...
const Sidefilter : React.FC<ClickProps> = ({ onClickAction,}) => {
    ...
    return (
    <div className="smx:hidden mt-10 flex shadow-lg rounded-lg cursor-pointer ring-1 ring-red-100 md:border-r-8 border-[var(--sienna)]  w-[200px] smx:w-[100%] smx:mx-auto md:pb-20 md:pr-0 p-4 gap-4">
