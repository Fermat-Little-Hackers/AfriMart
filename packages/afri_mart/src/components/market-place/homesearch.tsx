  ...
  return (
    <div className=''>
      <div className='menuBar flex flex-grow md:flex-row mx-5 md:mx-20 my-5 md:justify-between gap-2 md:gap-0 '>
        <div className='smx:w-[100%] flex mx-auto justify-end items-center w-[70rem]lmx:w-[100%] ring-1 ring-[var(--terracota)] h-10 p-5 pr-0 rounded-3xl smx:mx-auto smx:justify-end smx:mt-2'>
          <input
            type="search"
            name="search"
            id="search"
